...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    m_chosenAuto.setDefaultOption("Shoot and drive from middle",
      new ShootAndDriveAutoCommand(m_shooterSubsystem, m_robotDrive, m_intakeSubsystem, new Pose2d(0, 0, Rotation2d.fromDegrees(180)), this::getDelay));
    m_chosenAuto.addOption("Shoot and drive from left",
      new ShootAndDriveAutoCommand(m_shooterSubsystem, m_robotDrive, m_intakeSubsystem, new Pose2d(0, 0, Rotation2d.fromDegrees(235)), this::getDelay));
    m_chosenAuto.addOption("Shoot and drive from right",
      new ShootAndDriveAutoCommand(m_shooterSubsystem, m_robotDrive, m_intakeSubsystem, new Pose2d(0, 0, Rotation2d.fromDegrees(125)), this::getDelay));
    ...
    m_chosenAuto.addOption("Drive back only",
      new DriveAutoCommand(m_shooterSubsystem, m_robotDrive, new Pose2d(0,0,Rotation2d.fromDegrees(180)), this::getDelay));
    m_chosenAuto.addOption("Shoot only",
      new ShootAutoCommand(m_shooterSubsystem, m_robotDrive, m_intakeSubsystem, new Pose2d(0, 0, Rotation2d.fromDegrees(180)), this::getDelay).withTimeout(4));
    m_chosenAuto.addOption("2 rings",
      new TwoRingAutoCommand(m_shooterSubsystem, m_robotDrive, m_intakeSubsystem, new Pose2d(0, 0, Rotation2d.fromDegrees(180)), this::getDelay));
  ...
  public void zeroAfterAuto()
  {
    m_robotDrive.setOffset(m_robotDrive.getPose());
  }
