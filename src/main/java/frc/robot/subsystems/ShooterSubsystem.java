...
public class ShooterSubsystem extends SubsystemBase {
    ...
    public ShooterSubsystem() {
        ...
        m_frontIntakePower =
            m_shuffleboardtab
                .add("Front Intake Power", ShooterConstants.kFrontIntakePower)
                .withProperties(Map.of("min", -1.0, "max", 1.0))
                .getEntry();
        m_backIntakePower =
            m_shuffleboardtab
                .add("Back Intake Power", ShooterConstants.kBackIntakePower)
                .withProperties(Map.of("min", -1.0, "max", 1.0))
                .getEntry();
        m_indexPower =
            m_shuffleboardtab
        ...
        m_winchUpPower =
            m_shuffleboardtab
                .add("Winch Up Power", ShooterConstants.kWinchUpPower)
                .withProperties(Map.of("min", -1.0, "max", 1.0))
                .getEntry();
        m_winchDownPower =
            m_shuffleboardtab
                .add("Winch Down Power", ShooterConstants.kWinchDownPower)
                .withProperties(Map.of("min", -1.0, "max", 1.0))
                .getEntry();
    ...
    public double getIndexPower() {
        return clampPower(m_indexPower.getDouble(ShooterConstants.kIndexPower));
    }
    ...
    public void winchUp() {
        m_winchMotor.set(getWinchPowers()[0]);
    }

    public void winchDown() {
        m_winchMotor.set(getWinchPowers()[1]);
    }
