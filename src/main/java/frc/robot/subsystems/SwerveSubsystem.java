...
public class SwerveSubsystem extends SubsystemBase {
    ...
    public double getX() {
        return gyro.getDisplacementX() + offsetX;
    }

    public double getY() {
        return gyro.getDisplacementY() + offsetY;
    }
    ...
    public void setModuleStates(SwerveModuleState[] desiredStates) {
        SwerveDriveKinematics.desaturateWheelSpeeds(desiredStates, DriveConstants.kTeleMaxMetersPerSec);
    ...
    public void testMotor() {
        ...
        if (Controller.getYButton()) module = frontRight; else if (Controller.getXButton()) module =
            frontLeft; else if (Controller.getBButton()) module = backRight; else if (
