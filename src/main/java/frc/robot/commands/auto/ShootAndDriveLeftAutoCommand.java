...
public class ShootAndDriveLeftAutoCommand extends SequentialCommandGroup {
  @SuppressWarnings({"PMD.UnusedPrivateField", "PMD.SingularField"})

  public ShootAndDriveLeftAutoCommand(ShooterSubsystem shoot, SwerveSubsystem swerve) {
    super(
