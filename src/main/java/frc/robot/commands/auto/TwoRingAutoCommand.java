...
public class TwoRingAutoCommand extends SequentialCommandGroup {
  public TwoRingAutoCommand(LimelightSubsystem lime,ShooterSubsystem shoot, SwerveSubsystem swerve, IntakeSubsystem intake, Pose2d startingOffset, double delay) {
    super(
